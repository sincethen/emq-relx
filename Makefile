...
dep_emq_auth_username = git https://github.com/emqtt/emq-auth-username v2.3.0
...
dep_emq_auth_jwt      = git https://github.com/emqtt/emq-auth-jwt v2.3.0

# mqtt-sn, coap and stomp
dep_emq_sn    = git https://github.com/emqtt/emq-sn v2.3.0
dep_emq_coap  = git https://github.com/emqtt/emq-coap v2.3.0
dep_emq_stomp = git https://github.com/emqtt/emq-stomp v2.3.0

# plugin template
dep_emq_plugin_template = git https://github.com/emqtt/emq-plugin-template v2.3.0

# web_hook lua_hook
dep_emq_web_hook  = git https://github.com/emqtt/emq-web-hook v2.3.0
dep_emq_lua_hook  = git https://github.com/emqtt/emq-lua-hook v2.3.0
